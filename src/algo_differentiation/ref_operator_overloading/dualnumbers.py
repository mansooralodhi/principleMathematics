...
"""
copied !
source: https://github.com/Mostafa-Samir/Hands-on-Intro-to-Auto-Diff/blob/master/dualnumbers/dualnumbers.py#L3
"""
...
class DualNumber(object):
    ...
    def __init__(self, real, dual):
        ...
        dual: Number
            The coefficient of the dual component in the number
        """

        self.real = real # function value
        self.dual = dual # function derivative value
