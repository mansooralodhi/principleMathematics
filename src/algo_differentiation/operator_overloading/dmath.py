...
from mathematics.algo_differentiation.operator_overloading.dualnumbers import DualNumber

"""
copied !
source: https://github.com/Mostafa-Samir/Hands-on-Intro-to-Auto-Diff/blob/master/dualnumbers/dmath.py
"""
